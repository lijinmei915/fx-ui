...
export const docsNav: SiteNavSection[] = [
  ...
  { title: "数据录入", titleEn: "Data Entry", items: [{ label: "输入框", labelEn: "Input", href: "#input" }, { label: "选择器", labelEn: "Select", href: "#select" }, { label: "时间选择器", labelEn: "Time Picker", href: "#time-picker" }, { label: "日期选择器", labelEn: "Date Picker", href: "#date-picker" }, { label: "复选框", labelEn: "Checkbox", href: "#checkbox" }, { label: "单选组", labelEn: "Radio Group", href: "#radio-group" }, { label: "开关", labelEn: "Switch", href: "#switch" }, { label: "多行输入", labelEn: "Textarea", href: "#textarea" }, { label: "日历", labelEn: "Calendar", href: "#calendar" }, { label: "切换按钮", labelEn: "Toggle", href: "#toggle" }, { label: "切换按钮组", labelEn: "Toggle Group", href: "#toggle-group" }] },
