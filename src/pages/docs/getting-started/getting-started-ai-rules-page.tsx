...
export function GettingStartedAiRulesPage({ actions, lang, aiRules }: { actions: React.ReactNode; lang: "zh" | "en"; aiRules: AiRulesManifest }) {
  return (
    <div className={docsSpacing.pageStack}>
      <section id="ai-rules" className="flex flex-col gap-3"><PageLead crumb={lang === "en" ? "Maintain / AI Rules" : "维护 / AI 规则"} title={lang === "en" ? "AI Rules" : "AI 规则"} lead={lang === "en" ? "These rules keep AI-generated pages aligned with shadcn open-code, company tokens, and executable checks." : "这些规则用来保证 AI 生成页面时对齐 shadcn open-code、公司 token 和可执行检查。"} actions={actions} /></section>
