  ...
  return (
    <div className={docsSpacing.pageStack}>
      ...
      <section id="theme-source" className={docsSpacing.sectionStack}>
        ...
        <WebsiteCardContainer><CardContent className="grid gap-4 p-5 md:grid-cols-2"><div><Tag variant="secondary">ENTRY</Tag><h3 className="mt-3 font-medium">theme/fx-theme.css</h3><p className="mt-2 text-sm text-muted-foreground">{lang === "en" ? "The single runtime entry imports the protected Foundation and exposes semantic slots." : "唯一运行时入口固定导入受保护的 Foundation，并向组件暴露语义槽。"}</p></div><CopyCodeBlock code={themeImportCode} label="src/main.tsx" lang={lang} /></CardContent></WebsiteCardContainer>
      </section>
