...
export const docsNav: SiteNavSection[] = [
  { title: "设计令牌", titleEn: "Design Tokens", items: [{ label: "概览", labelEn: "Overview", href: "#tokens" }, { label: "颜色", labelEn: "Colors", href: "#tokens-colors" }, { label: "排版", labelEn: "Typography", href: "#tokens-typography" }, { label: "图标", labelEn: "Icons", href: "#tokens-icons" }, { label: "圆角", labelEn: "Radius", href: "#tokens-radius" }, { label: "阴影", labelEn: "Shadow", href: "#tokens-shadow" }, { label: "间距", labelEn: "Spacing", href: "#tokens-spacing" }, { label: "层级", labelEn: "Layer", href: "#tokens-layer" }, { label: "动效", labelEn: "Motion", href: "#tokens-motion" }] },
  { title: "布局系统", titleEn: "Layout", items: [{ label: "栅格", labelEn: "Grid", href: "#grid" }, { label: "布局", labelEn: "Layout", href: "#layout" }] },
  ...
  { title: "业务组合组件", titleEn: "Business Compositions", items: [{ label: "顶栏", labelEn: "TopBar", href: "#top-bar" }, { label: "页面头部", labelEn: "PageHeader", href: "#page-header" }, { label: "搜索工具栏", labelEn: "SearchToolbar", href: "#search-toolbar" }, { label: "实体表格", labelEn: "EntityTable", href: "#entity-table" }, { label: "表单分组", labelEn: "FormSection", href: "#form-section" }, { label: "危险确认框", labelEn: "ConfirmDangerDialog", href: "#confirm-danger-dialog" }] },
