...
export const docsNav: SiteNavSection[] = [
  ...
  { title: "数据录入", titleEn: "Data Entry", items: [{ label: "输入框", labelEn: "Input", href: "#input" }, { label: "选择器", labelEn: "Select", href: "#select" }, { label: "时间选择器", labelEn: "Time Picker", href: "#time-picker" }, { label: "日期选择器", labelEn: "Date Picker", href: "#date-picker" }, { label: "日期时间选择器", labelEn: "Date Time Picker", href: "#date-time-picker" }, { label: "复选框", labelEn: "Checkbox", href: "#checkbox" }, { label: "单选组", labelEn: "Radio Group", href: "#radio-group" }, { label: "开关", labelEn: "Switch", href: "#switch" }, { label: "多行输入", labelEn: "Textarea", href: "#textarea" }, { label: "日历", labelEn: "Calendar", href: "#calendar" }, { label: "切换按钮", labelEn: "Toggle", href: "#toggle" }, { label: "切换按钮组", labelEn: "Toggle Group", href: "#toggle-group" }] },
  { title: "数据展示", titleEn: "Data Display", items: [{ label: "表格", labelEn: "Table", href: "#table" }, { label: "卡片", labelEn: "Card", href: "#card" }, { label: "图表", labelEn: "Chart", href: "#chart" }, { label: "标签", labelEn: "Tag", href: "#tag" }, { label: "徽标", labelEn: "Badge", href: "#badge" }, { label: "提示", labelEn: "Tooltip", href: "#tooltip" }, { label: "折叠面板", labelEn: "Collapsible", href: "#collapsible" }] },
  ...
  { title: "维护", titleEn: "Maintain", items: [{ label: "现状", labelEn: "Status", href: "#governance-map" }, { label: "AI 规则", labelEn: "AI Rules", href: "#ai-rules" }, { label: "文档规范", labelEn: "Documentation", href: "#documentation" }, { label: "网站规范", labelEn: "Website Standards", href: "#website-standards" }, { label: "检查命令", labelEn: "Checks", href: "#checks" }] },
];
