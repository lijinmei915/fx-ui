    ...
    <div className={docsSpacing.pageStack}>
      ...
      <section id="tokens-shadow-compute" className={`${docsSpacing.sectionStack} scroll-mt-24`}>
        ...
        <DocSurfaceCard className="p-5 text-base text-muted-foreground">
          <p><span className="font-medium text-foreground">{lang === "en" ? "Color knobs" : "颜色总开关"}</span>：<code className="rounded bg-muted px-1 text-sm">--fds-g-color-shadow-default / soft / faint = 8% / 5% / 3%</code>{lang === "en" ? "，all derived from the darkest brand-tinted neutral rather than hard-coded black." : "，均从最深中性灰（带品牌色相）派生，不写死纯黑。"}</p>
