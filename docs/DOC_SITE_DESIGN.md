...
主题面板的字号基准同时代表文档站外壳密度：`12px` 是紧凑、`14px` 是标准、`16px` 是宽松。标准档按主流后台文档站观感收敛：顶栏 `56px`、左侧栏 `240px`、搜索框和工具栏按钮 `28–32px` 热区。主导航和侧栏入口使用独立菜单字号：12/14 基准显示 14px，16 基准显示 16px；紧凑和宽松只在这个基础上调整高度、内边距和分组间距，不改变页面信息层级。
